...
It was developed using a template generated by the [yeoman web-app generator](https://github.com/yeoman/generator-gulp-webapp).

You'll have to change the *PUBNUB_CHANNEL* and *PUBNUB_SUBSCRIBE_KEY* variables in main.js to point to your pubnub channel.
